...
5. 通过PUTTY使用SSH连接到设备（注意：树莓派默认不启动VNC，需要在SSH状态下开启VNC才可以使用VNC viewer远程连接桌面）
   ...
   4. 开启VNC服务
   5. 最后通过VNC viewer成功连接： <p align="center">
     <img src="/assets/1760698718329.png" alt="居中图片" width="400"/>
   </p>
...
3. 迁移存储路径：
 ...
 <p align="center">
     <img src="/assets/1760706441704.png" alt="居中图片" width="400"/>
   </p>
...
<p align="center">
     <img src="/assets/1760711553619.png" alt="居中图片" width="400"/>
   </p>
4. 安装Cloudflare客户端：
...
<p align="center">
           <img src="/assets/1760711699425.png" alt="居中图片" width="400"/>
         </p>
      <p align="center">
...
5. 配置Tunnel服务：
   ...
   1. 运行 `cloudflared tunnel create mycloud` ：由Cloudflare官方生成隧道ID（命令输出的最后一行）
       <p align="center">
     <img src="/assets/1760712578241.png" alt="居中图片" width="400"/>
   </p>
   2. 隧道配置文件：
...
<p align="center">
     <img src="/assets/1760714002970.png" alt="居中图片" width="400"/>
   </p>
